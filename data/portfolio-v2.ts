...
export const EPOCH_METRICS: Record<'I' | 'II' | 'III', EvidenceMetric[]> = {
    ...
    II: [
        ...
        { kind: 'status', label: 'Reasoning-Core', value: 'Gemini 2.5 Pro', source: 'operator.json · compliance.reasoning_core', verified: true },
...
export const BUILD_CASES: EvidenceCaseStudy[] = [
    ...
    },
    {
        ...
        architecture: 'React 19 · TypeScript · Vite · Firebase · Vertex AI · Gemini 2.5 Pro · europe-west3. ~40 Gemini-Agenten in synergetischer Orchestration (OMM v3.0 Framework). Perfect Twin Architecture als Doktrin: Google-Infra-Helix ∥ OMM-Logic-Helix, APEX 4-Layer Schutz, Aurora Protocol L0 → L3.',
    ...
    },
    {
        ...
        narrative: [
            ...
            { key: 'architecture', label: '04 · ARCHITECTURE', heading: 'Google-Cloud-exklusiv · EU-Compliance-Core.',
              body: 'Vertex AI · Gemini 2.5 Pro · BigQuery · Cloud Run · Firestore · GCP_EU_WEST3 (Frankfurt). Kein Cloud-Mix. Keine Shadow-Workflows. EU-Datenresidenz ist kein Feature, sondern Architektur-Eigenschaft.',
            ...
            { key: 'tradeoffs',    label: '06 · TRADEOFFS',    heading: 'Cloud-Lock-in vs. Souveränitätsgewinn.',
              body: 'Google-Cloud-Exklusivität erzeugt Lock-in. Dafür bekommt Columna: EU-Region Frankfurt, Vertex AI Reasoning Core auf Gemini 2.5 Pro, saubere Audit-Kette, keine Cross-Provider-Drift. Bewusste Entscheidung zugunsten Souveränität in EU-Kontext.',
        ...
        faqs: [
            ...
            { q: 'Warum ist Columna Google-Cloud-exklusiv?',
              a: 'Um EU-Datenresidenz, saubere Audit-Ketten und einen kohärenten Reasoning-Core (Vertex AI · Gemini 2.5 Pro · GCP_EU_WEST3 Frankfurt) zu garantieren. Lock-in ist bewusster Tradeoff für Souveränität im EU-Kontext.' },
        ...
        spec: [
            ...
            { key: 'product.reasoning',    value: 'Vertex AI · Gemini 2.5 Pro' },
